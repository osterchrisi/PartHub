...
@section('content')
    <div class="tos-container">
        ...
        <p>This privacy notice for PartHub, doing business as PartHub ("we," "us," or "our"), describes how and why we might
            collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as
            when you:</p>
        <p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights
            and choices. If you do not agree with our policies and practices, please do not use our Services.</p>

        <h2>SUMMARY OF KEY POINTS</h2>
        <p>This summary provides key points from our privacy notice, but you can find out more details about any of these
            topics by clicking the link following each key point or by using our <a href="#content-table">table of
                contents</a> below to find the section
        ...
        <ul>
            <li>What personal information do we process? When you visit, use, or navigate our Services, we may process
                ...
                products and features you use. <a href="#section1">Learn more about personal information you disclose to
                    us.</a></li>
            <li>Do we process any sensitive personal information? We do not process sensitive personal information.</li>
            <li>Do we collect any information from third parties? We may collect information from public databases,
                marketing partners, social media platforms, and other outside sources. <a href="#section3">Learn more about
                    information collected from other sources.</a></li>
            <li>How do we process your information? We process your information to provide, improve, and administer our
                ...
                a valid legal reason to do so. <a href="#section2">Learn more about how we process your information.</a></li>
            <li>In what situations and with which parties do we share personal information? We may share information in
                specific situations and with specific third parties. <a href="#section3">Learn more about when and with whom
                    we share your personal information.</a></li>
            <li>What are your rights? Depending on where you are located geographically, the applicable privacy law may mean
                you have certain rights regarding your personal information. <a href="#section9">Learn more about your
                    privacy rights.</a></li>
        ...
        {{-- <p><a href="#content-table">Review the privacy notice in full.</a></p> --}}

        <h2 id="content-table">TABLE OF CONTENTS</h2>
        <ul>
            <li><a href="#section1">1. WHAT INFORMATION DO WE COLLECT?</a></li>
            <li><a href="#section2">2. HOW DO WE PROCESS YOUR INFORMATION?</a></li>
            <li><a href="#section3">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a></li>
            <li><a href="#section4">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
            <li><a href="#section5">5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a></li>
            <li><a href="#section6">6. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</a></li>
            <li><a href="#section7">7. HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
            <li><a href="#section8">8. DO WE COLLECT INFORMATION FROM MINORS?</a></li>
            <li><a href="#section9">9. WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
        ...
        <div id="section2">
            ...
            <!-- Add any additional content under this section -->
        </div>
        ...
        <div id="section3">
            ...
            <p><strong>In Short:</strong> We may share information in specific situations described in this section and/or
                with the following third parties.</p>
        ...
        <div id="section4">
            ...
            <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to gather information when
                ...
                Services, prevent crashes, fix bugs, save your preferences, and assist with basic site functions.</p>
        ...
        <div id="section5">
            ...
            <p>Our Services offer you the ability to register and log in using your third-party social media account details
                ...
                picture, as well as other information you choose to make public on such a social media platform.</p>
        ...
        <div id="section6">
            ...
            <p><strong>In Short:</strong> We may transfer, store, and process your information in countries other than your
                own.</p>
            <p>Our servers are located in. If you are accessing our Services from outside, please be aware that your
                ...
                with whom we may share your personal information (see <a href="#section3">WHEN AND WITH WHOM DO WE SHARE
                    YOUR PERSONAL INFORMATION?</a> above), in and other countries.</p>
        ...
        <div id="section8">
            ...
            <p>We do not knowingly collect, solicit data from, or market to children under 18 years of age, nor do we
        ...
        <div id="section9">
            ...
            <p><strong>In Short:</strong> You may review, change, or terminate your account at any time, depending on your
                country, province, or state of residence.</p>

            <p>Withdrawing your consent: If we are relying on your consent to process your personal information, which may
                ...
                provided in the section <a href="#section12">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a> below.</p>
        ...
        <div id="section13">
            ...
            <p>Based on the applicable laws of your country, you may have the right to request access to the personal
                ...
                review, update, or delete your personal information, please fill out and submit a data subject access
                request.</p>
        </div>
    </div>
@endsection
