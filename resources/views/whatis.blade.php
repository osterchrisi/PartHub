...
@section('content')
    <div class="container my-5">
        <!-- Hero Section -->
        <x-hero-card 
            backgroundImage="app-related/hero-background.webp" 
            title="Welcome to PartHub"
            subtitle="Your Ultimate Inventory and BOM Management Solution"
            demoRoute="{{ route('demo.login') }}"
        ...
        <x-whatis-card
            ...
            bgClass="bg-primary bg-gradient text-white rounded" />

        <!-- Is PartHub For You? -->
        <x-whatis-card 
            title="Creativity starts here"
        ...
        <x-whatis-card 
            ...
            imageAlt=""
            content=""
            bgClass="bg-primary bg-gradient text-white shadow-sm rounded"
            :listItems="[
        ...
        <x-whatis-card 
            title="Who is Behind PartHub?"
            imageSrc="app-related/Chrisi_und_Kaja_square.webp"
            imageAlt="Christian and his dog Kaja"
            content='PartHub was created by <a href="https://christianzollner.com" target="_blank" class="text-white font-weight-bold">Christian Zollner</a>, founder of <a href="https://koma-elektronik.com" target="_blank" class="text-white font-weight-bold">KOMA Elektronik</a>. Christian programmed this software because no inventory tracking software of this kind existed for his company.'
            bgClass="bg-gradient text-white"
        />
        ...
        <x-whatis-card 
            ...
            bgClass="bg-primary bg-gradient text-white"
            ctaText="Sign Up Now"
