...
@section('content')
    <div class="tos-container">
        ...
        <p>We are PartHub, doing business as PartHub ("Company," "we," "us," "our"), a company registered in Germany at
            Koloniestr. 29, Berlin 13359.
            {{-- Our VAT number is DE285522050. --}}
        </p>
        <p>We operate the website <a href="https://parthub.online">https://parthub.online</a> (the "Site"), as well as any
            other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively,
            the "Services").</p>
        <p>We provide a platform for stock tracking and BOM management.</p>
        <p>You can contact us by email at <a href="mailto:hello@parthub.online">hello@parthub.online</a> or by mail to
            Koloniestr. 29, Berlin 13359, Germany.</p>
        <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an
            entity ("you"), and PartHub, concerning your access to and use of the Services. You agree that by accessing the
        ...
        <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal
            Terms will become effective upon posting or notifying you by <a
                href="mailto:hello@parthub.online">hello@parthub.online</a>, as stated in the email message. By continuing to
            use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
        <p>The Services are intended for users who are at least 18 years old. Persons under the age of 18 are not permitted
            to use or register for the Services.</p>
        ...
        <ul>
            ...
            <li><a href="#prohibited-activities">7. PROHIBITED ACTIVITIES</a></li>
            <li><a href="#user-generated-contributions">8. USER GENERATED CONTRIBUTIONS</a></li>
            <li><a href="#contribution-license">9. CONTRIBUTION LICENSE</a></li>
            <li><a href="#third-party-websites-and-content">10. THIRD-PARTY WEBSITES AND CONTENT</a></li>
            <li><a href="#advertisers">11. ADVERTISERS</a></li>
        ...
        <div id="our-services">
            ...
            <p>The Services are not tailored to comply with industry-specific regulations (Health Insurance Portability and
                ...
                a way that would violate the Gramm-Leach-Bliley Act (GLBA).</p>
        </div>
        ...
        <div id="intellectual-property-rights">
            ...
            <ul>
                ...
                <li>download or print a copy of any portion of the Content to which you have properly gained access, solely
                    for your personal, non-commercial use or internal business purpose.</li>
            </ul>
            ...
            <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or
                elsewhere in our Legal Terms, please address your request to: <a
                    href="mailto:hello@parthub.online">hello@parthub.online</a>. If we ever grant you the permission to
                ...
                or is visible on posting, reproducing, or displaying our Content.</p>
        ...
        <div id="subscriptions">
            ...
            <p>Your subscription will continue and automatically renew unless canceled. You consent to our charging your
                ...
                subscription plan you choose when you subscribed to the Services.</p>
            <h4>Free Trial</h4>
            <p>We offer a 30-day free trial to new users who register with the Services. The account will be charged
                according to the user's chosen subscription at the end of the free trial.</p>
            <h4>Cancellation</h4>
            <p>You can cancel your subscription at any time by logging into your account. Your cancellation will take effect
                at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please
                email us at <a href="mailto:hello@parthub.online">hello@parthub.online</a>.</p>
            <h4>Fee Changes</h4>
        ...
        <div id="prohibited-activities">
            ...
            <ul>
                ...
                <li>Circumvent, disable, or otherwise interfere with security-related features of the Services, including
                    ...
                    the Services and/or the Content contained therein.</li>
                ...
                <li>Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing any portion
                    of the Services to you.</li>
                <li>Attempt to bypass any measures of the Services designed to prevent or restrict access to the Services,
                    or any portion of the Services.</li>
                ...
                <li>Make any unauthorized use of the Services, including collecting usernames and/or email addresses of
        ...
        <div id="user-generated-contributions">
            ...
            <ul>
                ...
                <li>Your Contributions do not otherwise violate, or link to material that violates, any provision of these
                    Legal Terms, or any applicable law or regulation.</li>
            </ul>
        ...
        <div id="third-party-websites-and-content">
            <h3>10. THIRD-PARTY WEBSITES AND CONTENT</h3>
            <p>The Services may contain (or you may be sent via the Site) links to other websites ("Third-Party Websites")
                ...
                Services and access the Third-Party Websites or to use or install any Third-Party Content, you do so at your
                own risk, and you should be aware these Legal Terms no longer govern. You should review the applicable terms
                and policies, including privacy and data gathering practices, of any website to which you navigate from the
                Services or relating to any applications you use or install from the Services. Any purchases you make
        ...
        <div id="privacy-policy">
            ...
            <p>We care about data privacy and security. By using the Services, you agree to be bound by our Privacy Policy
                posted on the Services, which is incorporated into these Legal Terms. Please be advised the Services are
                hosted in Germany. If you access the Services from any other region of the world with laws or other
                requirements governing personal data collection, use, or disclosure that differ from applicable laws in
                Germany, then through your continued use of the Services, you are transferring your data to Germany, and you
                expressly consent to have your data transferred to and processed in Germany.</p>
        </div>
        ...
        <div id="modifications-and-interruptions">
            <h3>15. MODIFICATIONS AND INTERRUPTIONS</h3>
        ...
        <div id="governing-law">
            ...
            <p>These Legal Terms are governed by and interpreted following the laws of Germany, and the use of the United
                ...
                obligatory provisions of the law in your country to residence. PartHub and yourself both agree to submit to
                the non-exclusive jurisdiction of the courts of Berlin, which means that you may make a claim to defend your
                consumer protection rights in regards to these Legal Terms in Germany, or in the EU country in which you
                reside.</p>
        </div>
        ...
        <div id="dispute-resolution">
            ...
            <p>Any dispute arising from the relationships between the Parties to these Legal Terms shall be determined by
                ...
                clause constitutes acceptance. The seat of arbitration shall be Berlin, Germany. The language of the
                proceedings shall be German. Applicable rules of substantive law shall be the law of Germany.</p>
            <h4>Restrictions</h4>
        ...
        <div id="limitations-of-liability">
            <h3>20. LIMITATIONS OF LIABILITY</h3>
