  ...
  <div class="tab-content" id="partsTabsContent">
    <div class="tab-pane fade show active" id="partStockInfo" role="tabpanel" tabindex="0">
      ...
      <div class="input-group">
        ...
        <button type="button" class="btn btn-sm btn-outline-primary" onclick='callStockModal("1", <?php echo json_encode($locations) . ", $part_id"; ?>);'>Add</button>
        <button type="button" class="btn btn-sm btn-outline-primary" onclick='callStockModal("0", <?php echo json_encode($locations) . ", $part_id"; ?>);'>Move</button>
        <button type="button" class="btn btn-sm btn-outline-primary" onclick='callStockModal("-1", <?php echo json_encode($locations) . ", $part_id"; ?>);'>Reduce</button>
      </div>
      <br><br>
