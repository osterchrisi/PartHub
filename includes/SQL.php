...
{
  $stmt = $conn->query("SELECT location_id, location_name, stock_level_quantity FROM stock_levels JOIN location_names ON stock_levels.location_id_fk = location_names.location_id WHERE part_id_fk = $part_id");
